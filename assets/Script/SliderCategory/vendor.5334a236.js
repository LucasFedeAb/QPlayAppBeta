...
function o(e, t = "x") {
    ...
    return s.WebKitCSSMatrix ? (r = l.transform || l.webkitTransform,
        r.split(",").length > 6 && (r = r.split(", ").map((e => e.replace(",", "."))).join(", ")),
        a = new s.WebKitCSSMatrix("none" === r ? "" : r)) : (a = l.MozTransform || l.OTransform || l.MsTransform || l.msTransform || l.transform || l.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"),
            i = a.toString().split(",")),
    ...
    for (let r = 1; r < e.length; r += 1) {
        ...
        if (null != n && (i = n,
            ...
            for (let s = 0, i = e.length; s < i; s += 1) {
                ...
                void 0 !== r && r.enumerable && (d(t[i]) && d(n[i]) ? n[i].__swiper__ ? t[i] = n[i] : c(t[i], n[i]) : !d(t[i]) && d(n[i]) ? (t[i] = {},
...
function b(e = {}) {
    return w || (w = function ({ userAgent: e } = {}) {
        ...
        const p = r.match(/(iPod)(.*OS\s([\d_]+))?/)
            ...
            , f = "Win32" === i;
        let h = "MacIntel" === i;
        return !c && h && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${o}`) >= 0 && (c = r.match(/(Version)\/([\d.]+)/),
            c || (c = [0, 1, "13_0_0"]),
            h = !1),
            d && !f && (a.os = "android",
                a.android = !0),
...
function E(e) {
    ...
    let b = !0;
    u.matches(a.focusableElements) && (b = !1,
        "SELECT" === u.nodeName && (a.isTouched = !1)),
...
function M(e) {
    ...
    if (c.originalEvent && (c = c.originalEvent),
        !r.isTouched)
        return void (r.startMoving && r.isScrolling && s.emit("touchMoveOpposite", c));
    ...
    if (c.preventedByNestedSwiper)
        return a.startX = f,
            void (a.startY = h);
    if (!s.allowTouchMove)
        return c.target.matches(r.focusableElements) || (s.allowClick = !1),
        ...
        if (s.isVertical()) {
            if (h < a.startY && s.translate <= s.maxTranslate() || h > a.startY && s.translate >= s.minTranslate())
                return r.isTouched = !1,
                    void (r.isMoved = !1)
        } else if (f < a.startX && s.translate <= s.maxTranslate() || f > a.startX && s.translate >= s.minTranslate())
            return;
    if (t.activeElement && c.target === t.activeElement && c.target.matches(r.focusableElements))
        return r.isMoved = !0,
            void (s.allowClick = !1);
    if (r.allowTouchCallbacks && s.emit("touchMove", c),
    ...
    if (void 0 === r.isScrolling) {
        let e;
        s.isHorizontal() && a.currentY === a.startY || s.isVertical() && a.currentX === a.startX ? r.isScrolling = !1 : m * m + v * v >= 25 && (e = 180 * Math.atan2(Math.abs(v), Math.abs(m)) / Math.PI,
            r.isScrolling = s.isHorizontal() ? e > n.touchAngle : 90 - e > n.touchAngle)
    }
    if (r.isScrolling && s.emit("touchMoveOpposite", c),
        void 0 === r.startMoving && (a.currentX === a.startX && a.currentY === a.startY || (r.startMoving = !0)),
        r.isScrolling || s.zoom && s.params.zoom && s.params.zoom.enabled && r.evCache.length > 1)
    ...
    n.oneWayMovement && (g = Math.abs(g) * (o ? 1 : -1),
        w = Math.abs(w) * (o ? 1 : -1)),
        a.diff = g,
        g *= n.touchRatio,
        o && (g = -g,
    ...
    const S = s.params.loop && !(s.virtual && s.params.virtual.enabled) && !n.cssMode;
    if (!r.isMoved) {
        if (S && s.loopFix({
    ...
    let x = !0
        , y = n.resistanceRatio;
    if (n.touchReleaseOnEdges && (y = 0),
        g > 0 ? (S && !b && r.currentTranslate > (n.centeredSlides ? s.minTranslate() - s.size / 2 : s.minTranslate()) && s.loopFix({
            direction: "prev",
            setTranslate: !0,
            activeSlideIndex: 0
        }),
            r.currentTranslate > s.minTranslate() && (x = !1,
                n.resistance && (r.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + r.startTranslate + g) ** y))) : g < 0 && (S && !b && r.currentTranslate < (n.centeredSlides ? s.maxTranslate() + s.size / 2 : s.maxTranslate()) && s.loopFix({
                    direction: "next",
                    setTranslate: !0,
                    activeSlideIndex: s.slides.length - ("auto" === n.slidesPerView ? s.slidesPerViewDynamic() : Math.ceil(parseFloat(n.slidesPerView, 10)))
                }),
                    r.currentTranslate < s.maxTranslate() && (x = !1,
                        n.resistance && (r.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - r.startTranslate - g) ** y))),
...
function C(e) {
    ...
    if (t.allowClick) {
        ...
        t.updateClickedSlide(e && e[0] || p.target),
            t.emit("tap click", p),
            f < 300 && u - s.lastClickTime < 300 && t.emit("doubleTap doubleClick", p)
    }
    ...
    if (s.isTouched = !1,
        s.isMoved = !1,
        s.startMoving = !1,
        h = r.followFinger ? o ? t.translate : -t.translate : -s.currentTranslate,
        r.cssMode)
        return;
    ...
    for (let a = 0; a < d.length; a += a < r.slidesPerGroupSkip ? 1 : r.slidesPerGroup) {
        ...
        void 0 !== d[a + e] ? h >= d[a] && h < d[a + e] && (m = a,
            v = d[a + e] - d[a]) : h >= d[a] && (m = a,
    ...
    if (f > r.longSwipesMs) {
        ...
        "next" === t.swipeDirection && (T >= r.longSwipesRatio ? t.slideTo(r.rewind && t.isEnd ? g : m + S) : t.slideTo(m)),
            "prev" === t.swipeDirection && (T > 1 - r.longSwipesRatio ? t.slideTo(m + S) : null !== w && T < 0 && Math.abs(T) > r.longSwipesRatio ? t.slideTo(w) : t.slideTo(m))
    } else {
        if (!r.shortSwipes)
            return void t.slideTo(t.activeIndex);
        t.navigation && (p.target === t.navigation.nextEl || p.target === t.navigation.prevEl) ? p.target === t.navigation.nextEl ? t.slideTo(m + S) : t.slideTo(m) : ("next" === t.swipeDirection && t.slideTo(null !== g ? g : m + S),
...
function L() {
    ...
    !("auto" === t.slidesPerView || t.slidesPerView > 1) || !e.isEnd || e.isBeginning || e.params.centeredSlides || l ? e.params.loop && !a ? e.slideToLoop(e.realIndex, 0, !1, !0) : e.slideTo(e.activeIndex, 0, !1, !0) : e.slideTo(e.slides.length - 1, 0, !1, !0),
        e.autoplay && e.autoplay.running && e.autoplay.paused && (clearTimeout(P),
            P = setTimeout((() => {
                e.autoplay.resume()
            }
            ), 500)),
...
const _ = (e, t) => {
    ...
    n[d]("pointerdown", e.onTouchStart, {
        ...
        r.updateOnWindowResize ? e[c](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", L, !0) : e[c]("observerUpdate", L, !0),
        n[d]("load", e.onLoad, {
            capture: !0
        })
}
...
const $ = {
    ...
    update: {
        updateSize: function () {
            ...
            t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : i.clientWidth,
                ...
                0 === t && e.isHorizontal() || 0 === s && e.isVertical() || (t = t - parseInt(h(i, "padding-left") || 0, 10) - parseInt(h(i, "padding-right") || 0, 10),
                    s = s - parseInt(h(i, "padding-top") || 0, 10) - parseInt(h(i, "padding-bottom") || 0, 10),
                    Number.isNaN(t) && (t = 0),
                    Number.isNaN(s) && (s = 0),
                    Object.assign(e, {
                        width: t,
        ...
        updateSlides: function () {
            ...
            "string" == typeof E && E.indexOf("%") >= 0 && (E = parseFloat(E.replace("%", "")) / 100 * a),
                ...
                i.centeredSlides && i.cssMode && (p(r, "--swiper-centered-offset-before", ""),
            ...
            for (let p = 0; p < m; p += 1) {
                ...
                if (k = 0,
                    u[p] && (r = u[p]),
                    L && e.grid.updateSlide(p, r, m, t),
                    !u[p] || "none" !== h(r, "display")) {
                    if ("auto" === i.slidesPerView) {
                        ...
                        if (a && (r.style.transform = "none"),
                            ...
                            i.roundLengths)
                            k = e.isHorizontal() ? v(r, "width", !0) : v(r, "height", !0);
                        else {
                            const e = s(n, "width")
                                , t = s(n, "padding-left")
                                , i = s(n, "padding-right")
                        ...
                        k = (a - (i.slidesPerView - 1) * E) / i.slidesPerView,
                            i.roundLengths && (k = Math.floor(k)),
                            u[p] && (u[p].style[t("width")] = `${k}px`);
                    u[p] && (u[p].swiperSlideSize = k),
                        T.push(k),
                        i.centeredSlides ? (M = M + k / 2 + C / 2 + E,
                            0 === C && 0 !== p && (M = M - a / 2 - E),
                            0 === p && (M = M - a / 2 - E),
                            Math.abs(M) < .001 && (M = 0),
                            i.roundLengths && (M = Math.floor(M)),
                            P % i.slidesPerGroup == 0 && g.push(M),
                            w.push(M)) : (i.roundLengths && (M = Math.floor(M)),
                                (P - Math.min(e.params.slidesPerGroupSkip, P)) % e.params.slidesPerGroup == 0 && g.push(M),
                                w.push(M),
                                M = M + k + E),
                        e.virtualSize += k + E,
                        C = k,
            ...
            if (e.virtualSize = Math.max(e.virtualSize, a) + b,
                l && o && ("slide" === i.effect || "coverflow" === i.effect) && (r.style.width = `${e.virtualSize + i.spaceBetween}px`),
                i.setWrapperSize && (r.style[t("width")] = `${e.virtualSize + i.spaceBetween}px`),
            ...
            if (Object.assign(e, {
                ...
                p(r, "--swiper-centered-offset-before", -g[0] + "px"),
                    p(r, "--swiper-centered-offset-after", e.size / 2 - T[T.length - 1] / 2 + "px");
            ...
            if (m !== c && e.emit("slidesLengthChange"),
                g.length !== x && (e.params.watchOverflow && e.checkOverflow(),
        ...
        updateAutoHeight: function (e) {
            ...
            const a = e => i ? t.slides.filter((t => parseInt(t.getAttribute("data-swiper-slide-index"), 10) === e))[0] : t.slides[e];
        ...
        updateSlidesProgress: function (e = this && this.translate || 0) {
            ...
            for (let l = 0; l < i.length; l += 1) {
                ...
                const d = (a + (s.centeredSlides ? t.minTranslate() : 0) - o) / (e.swiperSlideSize + s.spaceBetween)
                    , c = (a - n[0] + (s.centeredSlides ? t.minTranslate() : 0) - o) / (e.swiperSlideSize + s.spaceBetween)
                    , p = -(a - o)
        ...
        updateProgress: function (e) {
            ...
            if (s.loop) {
                const s = m(t.slides.filter((e => "0" === e.getAttribute("data-swiper-slide-index")))[0])
                    , i = m(t.slides.filter((e => 1 * e.getAttribute("data-swiper-slide-index") == t.slides.length - 1))[0])
                    , r = t.slidesGrid[s]
                    , n = t.slidesGrid[i]
        ...
        updateClickedSlide: function (e) {
            ...
            t.clickedSlide = i,
                t.virtual && t.params.virtual.enabled ? t.clickedIndex = parseInt(i.getAttribute("data-swiper-slide-index"), 10) : t.clickedIndex = r,
        ...
        setTranslate: function (e, t) {
            ...
            s.isHorizontal() ? o = i ? -e : e : d = e,
                r.roundLengths && (o = Math.floor(o),
                    d = Math.floor(d)),
                r.cssMode ? n[s.isHorizontal() ? "scrollLeft" : "scrollTop"] = s.isHorizontal() ? -o : -d : r.virtualTranslate || (n.style.transform = `translate3d(${o}px, ${d}px, 0px)`),
    ...
    slide: {
        slideTo: function (e = 0, t = this.params.speed, s = !0, i, r) {
            ...
            let a = e;
            a < 0 && (a = 0);
            const { params: l, snapGrid: o, slidesGrid: d, previousIndex: c, activeIndex: p, rtlTranslate: f, wrapperEl: h, enabled: m } = n;
            ...
            if (l.normalizeSlideIndex)
                for (let u = 0; u < d.length; u += 1) {
                    ...
                    void 0 !== d[u + 1] ? e >= t && e < s - (s - t) / 2 ? a = u : e >= t && e < s && (a = u + 1) : e >= t && (a = u)
                }
            ...
            return n.setTransition(t),
                ...
                0 === t ? n.transitionEnd(s, T) : n.animating || (n.animating = !0,
        ...
        slideToLoop: function (e = 0, t = this.params.speed, s = !0, i) {
            ...
            const r = this;
            let n = e;
            return r.params.loop && (r.virtual && r.params.virtual.enabled ? n += r.virtual.slidesBefore : n = m(r.slides.filter((e => 1 * e.getAttribute("data-swiper-slide-index") === n))[0])),
                r.slideTo(n, t, s, i)
        },
            ...
            if (t.loop) {
                ...
                r = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10),
                    t.centeredSlides ? n < e.loopedSlides - i / 2 || n > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(),
                        n = m(f(s, `${l}[data-swiper-slide-index="${r}"]`)[0]),
                        a((() => {
                            e.slideTo(n)
                        }
    ...
    loop: {
        ...
        loopFix: function ({ slideRealIndex: e, slideTo: t = !0, direction: s, setTranslate: i, activeSlideIndex: r, byController: n } = {}) {
            const a = this;
            if (!a.params.loop)
                return;
            a.emit("beforeLoopFix");
            const { slides: l, allowSlidePrev: o, allowSlideNext: d, slidesEl: c, params: p } = a;
            if (a.allowSlidePrev = !0,
                a.allowSlideNext = !0,
                a.virtual && p.virtual.enabled)
                return t && (p.centeredSlides || 0 !== a.snapIndex ? p.centeredSlides && a.snapIndex < p.slidesPerView ? a.slideTo(a.virtual.slides.length + a.snapIndex, 0, !1, !0) : a.snapIndex === a.snapGrid.length - 1 && a.slideTo(a.virtual.slidesBefore, 0, !1, !0) : a.slideTo(a.virtual.slides.length, 0, !1, !0)),
                    a.allowSlidePrev = o,
                    a.allowSlideNext = d,
                    void a.emit("loopFix");
            const u = "auto" === p.slidesPerView ? a.slidesPerViewDynamic() : Math.ceil(parseFloat(p.slidesPerView, 10));
            let f = p.loopedSlides || u;
            f % p.slidesPerGroup != 0 && (f += p.slidesPerGroup - f % p.slidesPerGroup),
                a.loopedSlides = f;
            const h = []
                , v = [];
            let g = a.activeIndex;
            void 0 === r ? r = m(a.slides.filter((e => e.classList.contains("swiper-slide-active")))[0]) : g = r;
            const w = "next" === s || !s
                , T = "prev" === s || !s;
            let S = 0
                , b = 0;
    ...
    events: {
        attachEvents: function () {
            ...
            e.onTouchStart = E.bind(e),
                ...
                e.onClick = k.bind(e),
                e.onLoad = A.bind(e),
                O || (t.addEventListener("touchstart", G),
                    O = !0),
                _(e, "on")
        },
...
class N {
    constructor(...e) {
        ...
        if (s.el && "string" == typeof s.el && r.querySelectorAll(s.el).length > 1) {
            const e = [];
            return r.querySelectorAll(s.el).forEach((t => {
                const i = c({}, s, {
                    el: t
                });
                e.push(new N(i))
...
function F({ swiper: e, extendParams: t, on: s }) {
    t({
        parallax: {
            enabled: !1
        }
    ...
    const i = (t, s) => {
        ...
        , r = () => {
            const { el: t, slides: s, progress: r, snapGrid: n } = e;
            f(t, "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").forEach((e => {
                i(e, r)
            }
            )),
                s.forEach(((t, s) => {
                    let a = t.progress;
                    e.params.slidesPerGroup > 1 && "auto" !== e.params.slidesPerView && (a += Math.ceil(s / 2) - r * (n.length - 1)),
            ...
            setTranslate: function (t, s) {
                ...
                function o(t) {
                    ...
                    "slide" === e.params.controller.by && (!function (t) {
                        ...
                        a = -e.controller.spline.interpolate(-s)),
                        a && "container" !== e.params.controller.by || (n = (t.maxTranslate() - t.minTranslate()) / (e.maxTranslate() - e.minTranslate()),
                            a = (s - e.minTranslate()) * n + t.minTranslate()),
            ...
            setTransition: function (t, s) {
                ...
                if (Array.isArray(r))
                    for (n = 0; n < r.length; n += 1)
                        r[n] !== s && r[n] instanceof i && l(r[n]);
                else
                    r instanceof i && s !== r && l(r)
            }
        })
}
Object.keys($).forEach((e => {
    ...
    N.use([function ({ swiper: e, on: t, emit: s }) {
        const i = n();
        let r = null
            , a = null;
        const l = () => {
        ...
        t("init", (() => {
            e.params.resizeObserver && void 0 !== i.ResizeObserver ? e && !e.destroyed && e.initialized && (r = new ResizeObserver((t => {
                ...
                r.observe(e.el)) : (i.addEventListener("resize", l),
